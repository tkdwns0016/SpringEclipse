...
public class MybatisTest {
	...
	public void test() {
//		for(int i=0; i<5; i++) {
//			personMapper.insertPerson(new Person(0, "땡땡이"+i, i));
//		}
//		assertNotNull(personMapper);
//		personMapper.insertPerson(new Person(0, "콩콩이", 0));
//		personMapper.delete(1);
//		System.out.println(personMapper.update(new Person(2, "땡땡이00", 50)));
